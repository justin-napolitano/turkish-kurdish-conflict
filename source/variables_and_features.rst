...
.. csv-table:: Schema Table
    :header: "Variable Name","Description","Data Type"
    :widths: 20,20,20

    "Year","Records the year of the event.","Integer"
    "Side_A_Id","The unique identifier of the aggressor in an event.","Categorical Integer"
    "Side_A","The name of the aggressor in an event.","Categorical String"
    "Side_B_Id","The unique identifier of the Victim of an event.","Categorical Integer"
    "Side_B","The class of the victim an event.","Categorical String"
    ...
    "Kurdish Region","Designates whether a region contains a sizable Kurdish population.","String"
    "Region_Code","Region in Turkey where the event took place.","Categorical Integer"
    "Province_Name","The name of the Turkish Province in which an event took place.","Categorical String"
    ...
    "Human_right_violation_1_Code","Overarching human rights violation. See table 2.","Categorical Integer"
    "Human_right_violation_1_Name","Overarching human rights violation. See table 2.","String"
    "Human_right_violation_2_Code","Subcategory of human rights violation. See table 2","Categorical Integer"
    "Human_right_violation_2_Name","Subcategory of human rights violation. See table 2","String"
    "Is_Women_Event_Code",":Boolean" ,"Boolean"
    "Is_Women_Event","Boolean","String"
    "Is_Children_Event_Code","Boolean","Boolean"
    "Is_Children_Event","Boolean","String"
...
.. csv-table:: Schema Table Test
   :file: /csv/turkish_kurdish_conflict_view.csv
   :widths: 20, 70, 20
   :header-rows: 1
...
.. csv-table:: Schema Table Test 2
   :file: /csv/no_quotes.csv
   :widths: 20, 70, 20
   :header-rows: 1
